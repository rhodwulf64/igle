<?php
	...
	$lobjlista= new cls_Archiprestasgo();
   	$laMatriz=$lobjlista->fBusqueda_Sur();
?>
<!DOCTYPE html>
<html>
<head>
	<title>Archiprestasgo Sur</title>
...
<div Contenedor>
	<div contenido>
		...
		<div reflexion>
			<h2>Lista de Parroquias en Archiprestasgo Sur</h2>
			...
			<table border="1">
				...
				<?php 
					for ($x=0; $x <count($laMatriz) ; $x++) { 
						print"<tr>";
							print"<td><a href='Info_Archi.php?nombre=".$laMatriz[$x][0]."&direccion=".$laMatriz[$x][1]."&telefono=".$laMatriz[$x][2]."&fecha=".$laMatriz[$x][3]."&mision=".$laMatriz[$x][4]."&vision=".$laMatriz[$x][5]."&archi=SUR'>".$laMatriz[$x][0]."</a></td>";
						print"</tr>";
					}
				 ?>
			</table>
