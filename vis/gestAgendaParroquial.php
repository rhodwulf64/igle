<?php
  ...
  if(!array_key_exists("usuario", $_SESSION)) 
	...
	$lobj_Calendario->Cargar('tagendaparroquial'); //el numero 1 corresponde al tipo de Agenda, en este caso Diocesana
...
echo utf8_Decode('
			<div class="col-lg-12">
				<div Contenedor style=" background: #FFFFFF; -webkit-box-shadow: 2px 0px 10px 2px #999; -moz-box-shadow: 2px 0px 10px 2px #999; box-shadow: 2px 0px 10px 2px #999;">
					<div Cabecera>
						<p>Agenda Parroquial</p>
					</div>
					<div  id="calendar"></div>
					<div class="formulario" >
						<form method="POST" name="fr_agenda" id="fr_agenda" action="../cntller/cn_agendaParroquial.php">	
							<h2>Actividad 
		...
		if(fbValidar())
			{
				var $forme = $("#fr_agenda");
					...
					$.ajax(
					{
						url: \'../cntller/cn_agendaParroquial.php\',
						dataType: \'json\',
						type: \'post\',
				        ...
				        success: function(data)
				        {
							...
							if ((loF.txtOperacion.value=="incluir")&&(ReAgenda.liHay==1))
							{
								...
								setTimeout(function(){ document.location.href = "gestAgendaParroquial.php?CalendarioA="+ReAgenda.lsAnnoReg+"&CalendarioM="+ReAgenda.lsMesReg+""; }, 1000);
