		...
		<div class="col-lg-12">
			<input type="hidden" id="temporal"/>
				<table class="table table-striped table-bordered table-hover"  border="1" >
					<thead>		
						<tr>
							<th colspan="2"><center>Configuracion de Grado de Estudios</center></th>
						</tr>
					</thead>
				<tr colspan="2">
					<th>
						<center>
							<div class="form-group has-default" id="haf_listarGradoEstudio" style="width:400px;"><div class="on-focus clearfix" style="position: relative;"><font class="control-label">Seleccione Grado de Estudio a Editar:</font><br><select name="f_listarGradoEstudio" class="form-control" size="10" onchange="SeleccionaItem(this.value);" id="f_listarGradoEstudio" value="">');

							echo utf8_decode($loFuncion->fncreateComboSelectConf("gradoestudio", "","idTgradoEstudio","", ' ',"","Grado", $selectGradoEstudio,"", "", "")); 
							echo utf8_Decode('
							</select><div class="tool-tip  slideIn" id="ttipf_listarGradoEstudio" style="display:none;"></div></div></div>
						</center>
					</th>
				</tr>
				<tr colspan="2">
	...
	<div class="container" style="margin-top:5px; padding:5px; min-height: auto; background: #FFFFFF; -webkit-box-shadow: 0px 2px 5px 2px #999; -moz-box-shadow: 2px 2px 5px #999;">
		...
		<tr>
			<th colspan="2"><center>
					...
					<input type="hidden" name="KcharSelector" value="gradoestudio">	
...
<script>
	...
	{	
		...
		function fpEncender()
		{
			...
			loF.f_listarGradoEstudio.disabled=false;
			loF.f_descripcion.disabled=false;
		...
		function fpApagar()
		{
			...
			loF.f_listarGradoEstudio.disabled=true;
		...
		function fpCancelar()
		{
			...
			loF.txtHay.value=0;
			loF.f_listarGradoEstudio.value="";
		...
		{
			var valueIndex=loF.f_listarGradoEstudio.selectedIndex;
			loF.f_descripcion.value=loF.f_listarGradoEstudio.options[valueIndex].text;
			loF.KcodCombo.value=loF.f_listarGradoEstudio.options[valueIndex].value;
			loF.f_descripcion.focus();
