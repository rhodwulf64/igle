...
<body >
	...
	<?php $lobj_Cuerpo->f_Cabecera();?>
		...
		<div formulario>
			<h2></h2>
		<form name="form1" action="../controladores/cor_Agregar.php" method="POST" autocomplete="off">
			<input type='hidden' name="Control">
			
			<?php $lobj_Cuerpo->f_Control($la_Campos); ?>
			<fieldset><legend>Asignar Feligreses a grupos parroquia</legend>
				<table id="Agregar">
					<tr>
						<td>Parroquia </td>
						<td>
						...
						<td>Grupo</td>
						<td><input list="Grupo" validar="solo letras" name="Grupo" onblur="f_Blo();" value="<?php print($la_Campos['Grupo']);?>"/><br></td>
								<datalist id="Grupo" >
									
								</datalist>
								<datalist id="Grupo-2" >
									<?php $lobjCombo->fGenerar("Select *from grupo ;","codigo","nombre","","codigo_parr"); ?>
								</datalist>
