...
<html lang="es">
  <head>
		<title>'.$_SESSION['title'].' - Lista de Matrimonio</title>
...
<div class="container pre-scrollable" style="margin-top:5px; min-height: 530px; background: #FFFFFF; -webkit-box-shadow: 2px 0px 10px 2px #999; -moz-box-shadow: 2px 0px 10px 2px #999; box-shadow: 2px 0px 10px 2px #999;">
	...
	echo utf8_Decode('
		<form name="fr_Persona" action="reportes/listamatrimonio.php" method="post">
				<div class="col-lg-12">
					<table class="table table-striped table-bordered table-hover"  border="1" >
						<thead>		
							<tr>
								<th colspan="3"><center>Listado de Matrimonio</center></th>
							</tr>
						</thead>
					...
					<table class="table table-striped table-bordered table-hover"  border="1" >
						<thead>		
							...
							<th></th>
							<th width="15%">
								<input type="checkbox" name="option0" value="0"> Pendiente<br>
								<input type="checkbox" name="option1" value="1"> Casados<br>
								<input type="checkbox" name="option2" value="2"> Suspendidos<br>
								<input type="checkbox" name="option3" value="3"> Anulados<br>
							</th>
							<th></th>
							</tr>
						</thead>
