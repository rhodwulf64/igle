		...
		<div class="col-lg-12">
			<input type="hidden" id="temporal"/>
				<table class="table table-striped table-bordered table-hover"  border="1" >
					<thead>		
						<tr>
							<th colspan="2"><center>Configuracion de Parentescos</center></th>
						</tr>
					</thead>
				<tr colspan="2">
					<th>
						<center>
							...
							echo utf8_Decode('
							</select><div class="tool-tip  slideIn" id="ttipf_listarParentesco" style="display:none;"></div></div></div>
						</center>
					</th>
				</tr>
				<tr colspan="2">
...
<script>
	...
	{	
		...
		{
			var valueIndex=loF.f_listarParentesco.selectedIndex;
			loF.f_descripcion.value=loF.f_listarParentesco.options[valueIndex].text;
			loF.KcodCombo.value=loF.f_listarParentesco.options[valueIndex].value;
			loF.f_descripcion.focus();
