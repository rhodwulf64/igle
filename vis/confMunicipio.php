		...
		<div class="col-lg-12">
			<input type="hidden" id="temporal"/>
				<table class="table table-striped table-bordered table-hover"  border="1" >
					<thead>		
						<tr>
							<th colspan="2"><center>Configuracion de Municipios</center></th>
						</tr>
					</thead>
				<tr colspan="2">
					<th>
...
<script>
	...
	{	
		...
		function SeleccionaItem()
		{
			...
			loF.f_descripcion.value=loF.f_listarMunicipio.options[valueIndex].text;
			loF.KcodCombo.value=loF.f_listarMunicipio.options[valueIndex].value;

			$("#f_listarEstado option[value="+loF.f_listarMunicipio.options[valueIndex].className.replace(\'Mu\', \'\')+"]").attr("selected",true);
