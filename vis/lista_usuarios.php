...
<div class="container pre-scrollable" style="margin-top:5px; min-height: 530px; background: #FFFFFF; -webkit-box-shadow: 2px 0px 10px 2px #999; -moz-box-shadow: 2px 0px 10px 2px #999; box-shadow: 2px 0px 10px 2px #999;">
	...
	echo utf8_Decode('
		<form name="fr_Persona" action="reportes/listausuario.php" method="post">
				<div class="col-lg-12">
					<table class="table table-striped table-bordered table-hover"  border="1" >
						<thead>		
							<tr>
								<th colspan="3"><center>Listado de Usuarios</center></th>
							</tr>
						</thead>
						<tr>
							<th><center>
							<select id="cmb_rol" name="cmb_rol" style="width:200px;" class="form-control" onchange=""><option value="">Listar Todos</option>
							');
							echo utf8_decode($loFuncion->fncreateComboSelect("rol", "","idTRol","", ' ',"","Descripcion", $selectRold,"", "Prefijo", "")); 
