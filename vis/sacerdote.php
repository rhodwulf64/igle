...
<html lang="es">
  <head>
		<title>'.$_SESSION['title'].' - Inscripción del Sacerdote</title>
...
<div id="mascara" onclick="salir();"></div>
	...
	echo utf8_Decode('
		<form name="fr_Persona" id="fr_Persona" action="../cntller/cn_sacerdote.php" method="post">
				<div class="col-lg-12">
					<table class="table table-striped table-bordered table-hover"  border="1" >
						<thead>		
							<tr>
								<th colspan="3"><center>Inscripción del Sacerdote</center></th>
							</tr>
						</thead>
						<tr>
						...
						<tr>
							<th><div class="form-group has-default" id="haf_fechaInicioParroquia"><div class="on-focus clearfix" style="position: relative;"><span class="control-label" style="margin-right:2px;font-size:18px;color:red;">*</span><font class="control-label">Fecha Inicio en Parroquia:</font><input type="date" name="f_fechaInicioParroquia" id="f_fechaInicioParroquia" class="form-control" onblur="vSoloFechaAnterior(this.id);" value=""><div class="tool-tip  slideIn" id="ttipf_fechaInicioParroquia" style="display:none;"></div></div></div></th>
							<th><div class="form-group has-default" id="haf_fechaFinParroquia"><div class="on-focus clearfix" style="position: relative;"><span class="control-label" style="margin-right:2px;font-size:18px;color:red;">*</span><font class="control-label">Fecha Fin en Parroquia:</font><input type="date" name="f_fechaFinParroquia" id="f_fechaFinParroquia" class="form-control" onblur="vSoloFechaAnterior(this.id);" value=""><div class="tool-tip  slideIn" id="ttipf_fechaFinParroquia" style="display:none;"></div></div></div></th>
						</tr>
	...
	function fpInicio()
	{
		...
		function fpEncender()
		{
			...
			loF.f_fechaInicioParroquia.disabled=false;
			loF.f_fechaFinParroquia.disabled=false;
		...
		function fpApagar()
		{
			...
			loF.f_fechaInicioParroquia.disabled=true;
			loF.f_fechaFinParroquia.disabled=true;
		...
		function fpCancelar()
		{
			...
			loF.f_fechaInicioParroquia.value="";
			loF.f_fechaFinParroquia.value="";
			...
			document.getElementById("haf_fechaInicioParroquia").className = "form-group has-default";
			document.getElementById("haf_fechaFinParroquia").className = "form-group has-default";
...
function fpCombosDireccion(orden,objeto)
				        ...
				        success: function(data)
				        {
							...
							if((persona.lsCedula!=""))
							{
									if((loF.txtHacer.value=="buscar")&&(persona.liHay==1))
									{
										...
										loF.f_fechaInicioParroquia.value = persona.lsFechaInicioParroquia;
										loF.f_fechaFinParroquia.value = persona.lsFechaFinParroquia;
										...
										loF.f_fechaInicioParroquia.value = persona.lsObservacion;
										loF.f_fechaFinParroquia.value = persona.lsObservacion;
		...
		function fbValidar()
		{
			...
			if(vCampoVacio("f_fechaInicioParroquia"))
			{
				invalido=1;
			}
				...
				if(confirm("Desea Reactivar el Sacerdote?"))
				{
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro del Sacerdote ha sido Reactivado");
									loF.KestadoActual.value=1;
									fpInicial();
							}
							else	
				...
				if(confirm("Desea Desactivar el Sacerdote?"))
				{
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro del Sacerdote ha sido Desactivado");
									loF.KestadoActual.value=1;
									fpInicial();							
							}
							else	
		...
		function buscar_like(e){
			...
			var url = "../cntller/cn_sacerdote.php";
