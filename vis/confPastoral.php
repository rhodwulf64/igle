...
<html lang="es">
  <head>
		<title>'.$_SESSION['title'].' - Registro de Pastoral</title>
...
<div id="mascara" onclick="salir();"></div>
	...
	echo utf8_Decode('
		<form name="fr_Pastoral" id="fr_Pastoral" action="../cntller/cn_pastoral.php" method="post">
				<div class="col-lg-12">
					<table class="table table-striped table-bordered table-hover"  border="1" >
						<thead>		
							<tr>
								<th colspan="3"><center>Registro de Pastoral</center></th>
							</tr>
						</thead>
						<tr>
			...
			<table class="table table-striped table-bordered table-hover" border="1" style="margin:0px">
				<tr>
					<th colspan="2"><center>
						...
						<input type="hidden" name="txtIdPastoral" id="txtIdPastoral" value="">		
	...
	var loF=document.fr_Pastoral;
		...
		function buscar_like(e){
			...
			var url = "../cntller/cn_pastoral.php";
		...
		function fpSelectLike(idlke)
		{
			...
			loF.txtIdPastoral.value=lke.nvaidPastoral.value;
				        ...
				        success: function(data)
				        {
				        	var arrayDato=data[\'ArrDatos\'];
									...
									if((loF.txtHacer.value=="buscar")&&(arrayDato.liHay==1))
									{
										...
										loF.txtIdPastoral.value=arrayDato.lsidPastoral;
										loF.f_nombre.disabled=true;
										fpCambioE();
										fpApagar();
									...
									if ((loF.txtOperacion.value=="buscar")&&(loF.txtHacer.value=="buscar")&&(arrayDato.liHay==0))
									{
										...
										loF.f_nombre.value="";
										loF.f_nombre.focus();
										NotificaE("No se encontro Pastoral");
									}
		...
		function fpDesactivar()
		{
			...
			{
				if(confirm("Desea Reactivar Pastoral?"))
				{
					loF.f_mision.disabled=false;
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro de Pastoral ha sido Reactivado");
									loF.KestadoActual.value=1;
									fpInicial();
							}
							else	
							{
									fpCancelar();
									NotificaE("No se pudo Reactivar Pastoral");
									loF.KestadoActual.value=1;
									fpInicial();									
							}
						}
			...
			{
				if(confirm("Desea Desactivar Pastoral?"))
				{
					loF.f_mision.disabled=false;
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro de Pastoral ha sido Desactivado");
									loF.KestadoActual.value=1;
									fpInicial();							
							}
							else	
							{
									fpCancelar();
									NotificaE("No se pudo Desactivar Pastoral.");
									loF.KestadoActual.value=1;
									fpInicial();									
							}
						}
