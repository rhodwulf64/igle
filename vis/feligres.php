...
<div id="mascara" onclick="salir();"></div>
	...
	function fpInicio()
	{
		...
		function fpDesactivar()
		{
			...
			{
				if(confirm("Desea Reactivar '.$objetivo.'?"))
				{
					loF.f_cedula.disabled=false;
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro de '.$objetivo.' ha sido Reactivado");
									loF.KestadoActual.value=1;
									fpInicial();
							}
							else	
							{
									fpCancelar();
									NotificaE("No se pudo Reactivar '.$objetivo.'");
									loF.KestadoActual.value=1;
									fpInicial();									
							}
						}
			...
			{
				if(confirm("Desea Desactivar '.$objetivo.'?"))
				{
					loF.f_cedula.disabled=false;
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro de '.$objetivo.' ha sido Desactivado");
									loF.KestadoActual.value=1;
									fpInicial();							
							}
							else	
							{
									fpCancelar();
									NotificaE("No se pudo Desactivar '.$objetivo.'.");
									loF.KestadoActual.value=1;
									fpInicial();									
							}
						}
