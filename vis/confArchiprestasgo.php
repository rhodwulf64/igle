		...
		<div class="col-lg-12">
			<input type="hidden" id="temporal"/>
				<table class="table table-striped table-bordered table-hover"  border="1" >
					<thead>		
						<tr>
							<th colspan="2"><center>Configuracion de Archiprestasgo</center></th>
						</tr>
					</thead>
				<tr colspan="2">
					<th>
						<center>
							<div class="form-group has-default" onclick="fpAvisaSeleccionar(document.getElementById(\'KcodCombo\').value);" id="haf_listarArchiprestazgo" style="width:400px;"><div class="on-focus clearfix" style="position: relative;"><font class="control-label">Archiprestazgo a Editar:</font><br><select title="Debe presionar el boton \'Seleccionar\' antes de editar un elemento."name="f_listarArchiprestazgo" class="form-control" size="10" onblur="vCampoVacio(this.id);" onchange="SeleccionaItem(this.value);" id="f_listarArchiprestazgo" value="">');

							echo utf8_decode($loFuncion->fncreateComboSelectConf("archiprestazgo", "","codigoArchiPrestazgo","", ' ',"","nombre", $selectArchiprestazgo,"", "", "")); 
							echo utf8_Decode('
							</select><div class="tool-tip  slideIn" id="ttipf_listarArchiprestazgo" style="display:none;"></div></div></div>
						</center>
					</th>
				</tr>
				<tr colspan="2">
	...
	<div class="container" style="margin-top:5px; padding:5px; min-height: auto; background: #FFFFFF; -webkit-box-shadow: 0px 2px 5px 2px #999; -moz-box-shadow: 2px 2px 5px #999;">
		...
		<tr>
			<th colspan="2"><center>
					...
					<input type="hidden" name="KcharSelector" value="archiprestazgo">
...
<script>
	...
	{	
		...
		function fpEncender()
		{
			...
			loF.f_listarArchiprestazgo.disabled=false;
			loF.f_descripcion.disabled=false;
		...
		function fpApagar()
		{
			...
			loF.f_listarArchiprestazgo.disabled=true;
		...
		function fpCancelar()
		{
			...
			loF.txtHay.value=0;
			loF.f_listarArchiprestazgo.value="";
		...
		{
			var valueIndex=loF.f_listarArchiprestazgo.selectedIndex;
			loF.f_descripcion.value=loF.f_listarArchiprestazgo.options[valueIndex].text;
			loF.KcodCombo.value=loF.f_listarArchiprestazgo.options[valueIndex].value;
			loF.f_descripcion.focus();
