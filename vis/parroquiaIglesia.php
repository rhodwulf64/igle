...
<div id="mascara" onclick="salir();"></div>
	...
	echo utf8_Decode('
		<form name="fr_ParroquiaIglesia" id="fr_ParroquiaIglesia" action="../cntller/cn_parroquiaIglesia.php" method="post">
				<div class="col-lg-12">
					<table class="table table-striped table-bordered table-hover"  border="1" >
						<thead>		
							<tr>
								<th colspan="3"><center>Registro de Parroquia</center></th>
							</tr>
						</thead>
						<tr>
						...
						<tr>
							...
							<th>
							<div class="form-group has-default" id="hacmb_Archiprestasgo"><div class="on-focus clearfix" style="position: relative;"><span class="control-label" style="margin-right:2px;font-size:18px;color:red;">*</span><label class="control-label">Archiprestasgo:</label><select id="cmb_Archiprestasgo" name="cmb_Archiprestasgo" class="form-control" tabindex="10" onblur="vCampoVacio(this.id);" onchange="fpCombosDireccion(\'Ciudad\',this.id)"><option value="0">*Seleccione Archiprestasgo</option>
							');
							echo utf8_decode($loFuncion->fncreateComboSelect("archiprestazgo", "","codigoArchiPrestazgo","", ' ',"","nombre", $selectarchiprestazgo,"", "", "")); 
							echo utf8_Decode('</select><div class="tool-tip  slideIn" id="ttipcmb_Archiprestasgo" style="display:none;"></div></div></div>
							</th>
							');
			...
			<table class="table table-striped table-bordered table-hover" border="1" style="margin:0px">
				<tr>
					<th colspan="2"><center>
						...
						<input type="hidden" name="txtidParroquia" id="txtidParroquia" value="">	
	...
	<script>
	var loF=document.fr_ParroquiaIglesia;
		...
		function fpEncender()
		{
			...
			loF.cmb_Archiprestasgo.disabled=false;
		...
		function fpApagar()
		{
			...
			loF.cmb_Archiprestasgo.disabled=true;
		...
		function buscar_like(e){
			...
			var url = "../cntller/cn_parroquiaIglesia.php";
		...
		function fpSelectLike(idlke)
		{
			...
			loF.txtidParroquia.value=lke.nvaidParroquia.value;
		...
		function fpPerderFocus()
		{
				...
				var $forme = $("#fr_ParroquiaIglesia");

					$.ajax({
						url: \'../cntller/cn_parroquiaIglesia.php\',
						dataType: \'json\',
						type: \'post\',
				        ...
				        success: function(data)
				        {
							...
							{
								loF.txtidParroquia.value = arrayDato.lsidParroquiaIglesia;
								...
								loF.cmb_Archiprestasgo.value = arrayDato.lsCodigo_archi;
							...
							if ((loF.txtOperacion.value=="buscar")&&(loF.txtHacer.value=="buscar")&&(arrayDato.liHay==0))
							{
								...
								loF.f_nombre.value="";
								loF.f_nombre.focus();
								NotificaE("No se encontro Parroquia con la cedula ingresada.")
							}
		...
		function fpPredeterminado()
		{
			...
			{
				fpEncender();
				document.getElementById("haf_mision").className = "form-group has-success";
				loF.f_mision.disabled=true;
				loF.txtOperacion.value="incluir";
				loF.txtHacer.value="incluir";
				loF.txtHay.value=0;
				loF.f_mision.value=Cedu;
				loF.f_nombre.focus();
				fpCambioN();
		...
		{
			loF.f_mision.value="'.$CeduImportada.'";
			loF.f_mision.disabled=false;
			loF.txtOperacion.value="buscar";
			loF.txtHacer.value="buscar";
			loF.txtHay.value=0;
		...
		function fbValidar()
		{
			...
			if(vCampoVacioDireccion("cmb_Archiprestasgo"))
			{
				invalido=1;
			}
			if (invalido==0)
				...
				if(confirm("Desea Reactivar Parroquia?"))
				{
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro de Parroquia ha sido Reactivado");
									loF.KestadoActual.value=1;
									fpInicial();
							}
							else	
				...
				if(confirm("Desea Desactivar Parroquia?"))
				{
					...
					$.ajax({
				        ...
				        success: function(data){
							...
							{
									fpCancelar();
									NotificaS("Registro de Parroquia ha sido Desactivado");
									loF.KestadoActual.value=1;
									fpInicial();							
							}
							else	
