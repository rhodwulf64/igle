<?php
	...
	$lobjlista= new cls_Archiprestasgo();
   	$laMatriz=$lobjlista->fBusqueda_Centro();
?>
<!DOCTYPE html>
<html>
<head>
	<title>Archiprestasgo Centro</title>
...
<div Contenedor>
	<div contenido>
		...
		<div reflexion>
			<h2>Lista de Parroquias en Archiprestasgo Centro</h2>
			<style type="text/css">
				table{
			...
			<table border="1">
				...
				<?php 
					for ($x=0; $x <count($laMatriz) ; $x++) { 
						print"<tr>";
							print"<td><a href='Info_Archi.php?nombre=".$laMatriz[$x][0]."&direccion=".$laMatriz[$x][1]."&telefono=".$laMatriz[$x][2]."&fecha=".$laMatriz[$x][3]."&mision=".$laMatriz[$x][4]."&vision=".$laMatriz[$x][5]."&archi=CENTRO'>".$laMatriz[$x][0]."</a></td>";
						print"</tr>";
					}
				 ?>
			</table>
